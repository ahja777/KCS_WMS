...
/* ── Location text popup (free-text since locations are codes) ─ */
...
/* ================================================================
   Main Page – 로케이션별재고현황 (Slide 85)
   Grid: 로케이션, 창고, 화주, 상품코드, 상품명, 수량, UOM, 적치율(%), 가용PLT
   ================================================================ */
      ...
      render: (row) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <div className="h-4 w-20 overflow-hidden rounded-full bg-[#F2F4F6]">
              <div
                className="h-full rounded-full bg-red-500 transition-all"
                style={{ width: `${rate}%` }}
              />
            </div>
            <span className="text-xs font-medium text-[#4E5968]">{rate}%</span>
          </div>
        );
      },
    },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#191F28]">로케이션별재고현황</h1>
            <p className="text-sm text-[#8B95A1]">리포트 &gt; 로케이션별재고현황</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
