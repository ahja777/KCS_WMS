...
async function main() {
    ...
    async function createZonesAndLocations(warehouseId, zoneDefs) {
        const createdZones = {};
    ...
    const itemsData = [
        { code: 'ELEC-001', name: '노트북', description: '15.6인치 비즈니스 노트북', barcode: '8801234560001', category: 'ELECTRONICS', uom: 'EA', weight: 2.1, length: 36, width: 25, height: 2.5, minStock: 10, maxStock: 200 },
        { code: 'ELEC-002', name: '태블릿', description: '10.5인치 태블릿 PC', barcode: '8801234560002', category: 'ELECTRONICS', uom: 'EA', weight: 0.5, length: 25, width: 17, height: 0.7, minStock: 20, maxStock: 300 },
        { code: 'ELEC-003', name: '스마트폰', description: '최신형 스마트폰', barcode: '8801234560003', category: 'ELECTRONICS', uom: 'EA', weight: 0.2, length: 16, width: 7.5, height: 0.8, minStock: 50, maxStock: 500 },
        { code: 'ELEC-004', name: '이어폰', description: '무선 블루투스 이어폰', barcode: '8801234560004', category: 'ELECTRONICS', uom: 'EA', weight: 0.05, length: 8, width: 8, height: 3, minStock: 100, maxStock: 1000 },
        { code: 'ELEC-005', name: '충전기', description: '고속 충전기 65W', barcode: '8801234560005', category: 'ELECTRONICS', uom: 'EA', weight: 0.15, length: 6, width: 6, height: 3, minStock: 100, maxStock: 800 },
        { code: 'CLTH-001', name: '티셔츠', description: '면 100% 라운드 티셔츠', barcode: '8801234560006', category: 'CLOTHING', uom: 'EA', weight: 0.2, length: 30, width: 25, height: 3, minStock: 50, maxStock: 500 },
        { code: 'CLTH-002', name: '자켓', description: '방수 바람막이 자켓', barcode: '8801234560007', category: 'CLOTHING', uom: 'EA', weight: 0.6, length: 40, width: 30, height: 5, minStock: 30, maxStock: 300 },
        { code: 'CLTH-003', name: '청바지', description: '슬림핏 데님 청바지', barcode: '8801234560008', category: 'CLOTHING', uom: 'EA', weight: 0.7, length: 35, width: 30, height: 5, minStock: 30, maxStock: 300 },
        { code: 'CLTH-004', name: '운동화', description: '런닝 운동화', barcode: '8801234560009', category: 'CLOTHING', uom: 'EA', weight: 0.8, length: 32, width: 20, height: 12, minStock: 20, maxStock: 200 },
        { code: 'CLTH-005', name: '모자', description: '캐주얼 볼캡 모자', barcode: '8801234560010', category: 'CLOTHING', uom: 'EA', weight: 0.1, length: 20, width: 15, height: 10, minStock: 50, maxStock: 400 },
        { code: 'GENR-001', name: 'USB케이블', description: 'USB-C 고속 충전 케이블 1m', barcode: '8801234560011', category: 'GENERAL', uom: 'EA', weight: 0.03, length: 15, width: 5, height: 2, minStock: 200, maxStock: 2000 },
        { code: 'GENR-002', name: '보조배터리', description: '20000mAh 보조배터리', barcode: '8801234560012', category: 'GENERAL', uom: 'EA', weight: 0.35, length: 14, width: 7, height: 2.5, minStock: 50, maxStock: 500 },
        { code: 'GENR-003', name: '마우스', description: '무선 인체공학 마우스', barcode: '8801234560013', category: 'GENERAL', uom: 'EA', weight: 0.1, length: 12, width: 7, height: 4, minStock: 50, maxStock: 400 },
        { code: 'GENR-004', name: '키보드', description: '기계식 무선 키보드', barcode: '8801234560014', category: 'GENERAL', uom: 'EA', weight: 0.8, length: 44, width: 14, height: 4, minStock: 30, maxStock: 300 },
        { code: 'GENR-005', name: '모니터', description: '27인치 4K UHD 모니터', barcode: '8801234560015', category: 'GENERAL', uom: 'EA', weight: 5.5, length: 62, width: 20, height: 45, minStock: 5, maxStock: 100 },
        { code: 'FOOD-001', name: '라면박스', description: '신라면 40개입 박스', barcode: '8801234560016', category: 'FOOD', uom: 'BOX', weight: 4.8, length: 40, width: 30, height: 25, minStock: 30, maxStock: 500 },
        { code: 'FOOD-002', name: '김세트', description: '프리미엄 조미김 선물세트', barcode: '8801234560017', category: 'FOOD', uom: 'BOX', weight: 1.2, length: 30, width: 20, height: 10, minStock: 50, maxStock: 600 },
        { code: 'FOOD-003', name: '고추장', description: '태양초 고추장 1kg', barcode: '8801234560018', category: 'FOOD', uom: 'EA', weight: 1.1, length: 12, width: 12, height: 15, minStock: 40, maxStock: 400 },
        { code: 'FOOD-004', name: '참기름', description: '순수 참기름 500ml', barcode: '8801234560019', category: 'FOOD', uom: 'EA', weight: 0.55, length: 7, width: 7, height: 20, minStock: 40, maxStock: 400 },
        { code: 'FOOD-005', name: '김치', description: '전통 포기김치 5kg', barcode: '8801234560020', category: 'FOOD', uom: 'EA', weight: 5.2, length: 30, width: 20, height: 15, minStock: 20, maxStock: 200 },
    ];
    const items = {};
    ...
    const partnersData = [
        { code: 'SUP-SAMSUNG', name: '삼성전자', type: 'SUPPLIER', contactName: '이수진', contactPhone: '+82-2-2255-0100', contactEmail: 'supply@samsung-sample.com', country: 'Korea', city: 'Seoul', address: '서울시 서초구 서초대로 74길 11' },
        { code: 'SUP-LG', name: 'LG전자', type: 'SUPPLIER', contactName: '박정호', contactPhone: '+82-2-3777-0200', contactEmail: 'supply@lg-sample.com', country: 'Korea', city: 'Seoul', address: '서울시 영등포구 여의대로 128' },
        { code: 'SUP-KFOOD', name: '한국식품', type: 'SUPPLIER', contactName: '최민수', contactPhone: '+82-2-1234-5678', contactEmail: 'export@kfood-sample.com', country: 'Korea', city: 'Busan', address: '부산시 해운대구 센텀중앙로 48' },
        { code: 'CUS-AMAZON', name: 'Amazon US', type: 'CUSTOMER', contactName: 'Sarah Williams', contactPhone: '+1-206-555-0100', contactEmail: 'vendor@amazon-sample.com', country: 'USA', city: 'Seattle', address: '410 Terry Ave N, Seattle, WA 98109' },
        { code: 'CUS-WALMART', name: 'Walmart', type: 'CUSTOMER', contactName: 'James Brown', contactPhone: '+1-479-555-0200', contactEmail: 'supply@walmart-sample.com', country: 'USA', city: 'Bentonville', address: '702 SW 8th St, Bentonville, AR 72716' },
        { code: 'CUS-MEDIAMARKT', name: 'MediaMarkt', type: 'CUSTOMER', contactName: 'Klaus Weber', contactPhone: '+49-841-555-0300', contactEmail: 'einkauf@mediamarkt-sample.com', country: 'Germany', city: 'Ingolstadt', address: 'Wankelstrasse 5, 85046 Ingolstadt' },
        { code: 'CAR-FEDEX', name: 'FedEx', type: 'CARRIER', contactName: 'Tom Davis', contactPhone: '+1-800-463-3339', contactEmail: 'ops@fedex-sample.com', country: 'USA', city: 'Memphis', address: '942 S Shady Grove Rd, Memphis, TN 38120' },
        { code: 'CAR-DHL', name: 'DHL', type: 'CARRIER', contactName: 'Anna Schmidt', contactPhone: '+49-228-555-0400', contactEmail: 'ops@dhl-sample.com', country: 'Germany', city: 'Bonn', address: 'Charles-de-Gaulle-Strasse 20, 53113 Bonn' },
    ];
    const partners = {};
    ...
    const txData = [
        { itemId: items['ELEC-001'].id, warehouseId: whLA.id, locationCode: 'B-01-01-01', lotNo: 'LOT-LA-2026-001', txType: 'INBOUND', quantity: 48, referenceType: 'INBOUND_ORDER', referenceId: ib001.id, performedBy: operator1.name, createdAt: new Date('2026-02-13') },
        { itemId: items['ELEC-003'].id, warehouseId: whLA.id, locationCode: 'B-01-02-01', lotNo: 'LOT-LA-2026-002', txType: 'INBOUND', quantity: 100, referenceType: 'INBOUND_ORDER', referenceId: ib001.id, performedBy: operator1.name, createdAt: new Date('2026-02-13') },
        { itemId: items['ELEC-004'].id, warehouseId: whLA.id, locationCode: 'B-02-01-01', lotNo: 'LOT-LA-2026-002', txType: 'INBOUND', quantity: 200, referenceType: 'INBOUND_ORDER', referenceId: ib001.id, performedBy: operator1.name, createdAt: new Date('2026-02-13') },
        { itemId: items['ELEC-003'].id, warehouseId: whLA.id, locationCode: 'B-01-02-01', lotNo: 'LOT-LA-2026-002', txType: 'OUTBOUND', quantity: -30, referenceType: 'OUTBOUND_ORDER', referenceId: ob001.id, performedBy: operator1.name, createdAt: new Date('2026-02-20') },
        { itemId: items['ELEC-004'].id, warehouseId: whLA.id, locationCode: 'B-02-01-01', lotNo: 'LOT-LA-2026-002', txType: 'OUTBOUND', quantity: -50, referenceType: 'OUTBOUND_ORDER', referenceId: ob001.id, performedBy: operator1.name, createdAt: new Date('2026-02-20') },
        { itemId: items['FOOD-001'].id, warehouseId: whNJ.id, locationCode: 'B-01-01-01', lotNo: 'LOT-NJ-2026-001', txType: 'INBOUND', quantity: 100, referenceType: 'INBOUND_ORDER', referenceId: ib002.id, performedBy: operator1.name, createdAt: new Date('2026-02-17') },
        { itemId: items['FOOD-002'].id, warehouseId: whNJ.id, locationCode: 'B-01-02-01', lotNo: 'LOT-NJ-2026-001', txType: 'INBOUND', quantity: 148, referenceType: 'INBOUND_ORDER', referenceId: ib002.id, performedBy: operator1.name, createdAt: new Date('2026-02-17') },
        { itemId: items['FOOD-003'].id, warehouseId: whNJ.id, locationCode: 'B-02-01-01', lotNo: 'LOT-NJ-2026-001', txType: 'INBOUND', quantity: 80, referenceType: 'INBOUND_ORDER', referenceId: ib002.id, performedBy: operator1.name, createdAt: new Date('2026-02-17') },
        { itemId: items['FOOD-004'].id, warehouseId: whNJ.id, locationCode: 'B-02-02-01', lotNo: 'LOT-NJ-2026-001', txType: 'INBOUND', quantity: 60, referenceType: 'INBOUND_ORDER', referenceId: ib002.id, performedBy: operator1.name, createdAt: new Date('2026-02-17') },
        { itemId: items['FOOD-001'].id, warehouseId: whNJ.id, locationCode: 'B-01-01-01', lotNo: 'LOT-NJ-2026-001', txType: 'OUTBOUND', quantity: -40, referenceType: 'OUTBOUND_ORDER', referenceId: ob002.id, performedBy: operator1.name, createdAt: new Date('2026-03-15') },
        { itemId: items['FOOD-002'].id, warehouseId: whNJ.id, locationCode: 'B-01-02-01', lotNo: 'LOT-NJ-2026-001', txType: 'OUTBOUND', quantity: -60, referenceType: 'OUTBOUND_ORDER', referenceId: ob002.id, performedBy: operator1.name, createdAt: new Date('2026-03-15') },
        { itemId: items['FOOD-003'].id, warehouseId: whNJ.id, locationCode: 'B-02-01-01', lotNo: 'LOT-NJ-2026-001', txType: 'OUTBOUND', quantity: -30, referenceType: 'OUTBOUND_ORDER', referenceId: ob002.id, performedBy: operator1.name, createdAt: new Date('2026-03-15') },
        { itemId: items['ELEC-001'].id, warehouseId: whLA.id, locationCode: 'B-01-01-01', lotNo: 'LOT-LA-2026-001', txType: 'ADJUSTMENT_OUT', quantity: -2, referenceType: 'STOCK_ADJUSTMENT', notes: '입고 시 파손 처리 (노트북 2개)', performedBy: manager.name, createdAt: new Date('2026-02-14') },
        { itemId: items['FOOD-002'].id, warehouseId: whNJ.id, locationCode: 'B-01-02-01', lotNo: 'LOT-NJ-2026-001', txType: 'ADJUSTMENT_OUT', quantity: -2, referenceType: 'STOCK_ADJUSTMENT', notes: '입고 시 파손 처리 (김세트 2개)', performedBy: manager.name, createdAt: new Date('2026-02-18') },
        { itemId: items['ELEC-005'].id, warehouseId: whLA.id, locationCode: 'C-01-01-01', lotNo: 'LOT-LA-2025-010', txType: 'INBOUND', quantity: 120, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-12-15') },
        { itemId: items['CLTH-001'].id, warehouseId: whLA.id, locationCode: 'C-01-02-01', lotNo: 'LOT-LA-2025-011', txType: 'INBOUND', quantity: 180, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-12-20') },
        { itemId: items['CLTH-004'].id, warehouseId: whLA.id, locationCode: 'C-02-01-01', lotNo: 'LOT-LA-2025-012', txType: 'INBOUND', quantity: 60, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-12-20') },
        { itemId: items['ELEC-001'].id, warehouseId: whLA.id, locationCode: 'B-01-01-01', lotNo: 'LOT-LA-2026-001', txType: 'TRANSFER', quantity: -5, referenceType: 'TRANSFER', performedBy: operator2.name, createdAt: new Date('2026-03-10'), notes: '피킹 구역으로 이동 [FROM B-01-01-01 TO D-01-01-01]' },
        { itemId: items['ELEC-001'].id, warehouseId: whLA.id, locationCode: 'D-01-01-01', lotNo: 'LOT-LA-2026-001', txType: 'TRANSFER', quantity: 5, referenceType: 'TRANSFER', performedBy: operator2.name, createdAt: new Date('2026-03-10'), notes: '피킹 구역으로 이동 [FROM B-01-01-01 TO D-01-01-01]' },
        { itemId: items['GENR-001'].id, warehouseId: whNJ.id, locationCode: 'B-02-01-01', lotNo: 'LOT-NJ-2025-006', txType: 'INBOUND', quantity: 400, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-11-30') },
        { itemId: items['FOOD-005'].id, warehouseId: whNJ.id, locationCode: 'B-01-01-01', lotNo: 'LOT-NJ-2025-005', txType: 'INBOUND', quantity: 35, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-12-10') },
        { itemId: items['ELEC-001'].id, warehouseId: whHH.id, locationCode: 'B-01-01-01', lotNo: 'LOT-HH-2025-001', txType: 'INBOUND', quantity: 25, referenceType: 'INITIAL_STOCK', performedBy: manager2.name, createdAt: new Date('2025-11-20') },
        { itemId: items['GENR-003'].id, warehouseId: whHH.id, locationCode: 'B-01-02-01', lotNo: 'LOT-HH-2025-002', txType: 'INBOUND', quantity: 60, referenceType: 'INITIAL_STOCK', performedBy: manager2.name, createdAt: new Date('2025-11-20') },
        { itemId: items['GENR-004'].id, warehouseId: whHH.id, locationCode: 'B-02-01-01', lotNo: 'LOT-HH-2025-003', txType: 'INBOUND', quantity: 45, referenceType: 'INITIAL_STOCK', performedBy: manager2.name, createdAt: new Date('2025-11-20') },
        { itemId: items['GENR-005'].id, warehouseId: whHH.id, locationCode: 'B-02-02-01', lotNo: 'LOT-HH-2025-004', txType: 'INBOUND', quantity: 15, referenceType: 'INITIAL_STOCK', performedBy: manager2.name, createdAt: new Date('2025-11-20') },
        { itemId: items['ELEC-002'].id, warehouseId: whTK.id, locationCode: 'B-01-01-01', lotNo: 'LOT-TK-2025-001', txType: 'INBOUND', quantity: 30, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-10-15') },
        { itemId: items['GENR-002'].id, warehouseId: whTK.id, locationCode: 'B-01-02-01', lotNo: 'LOT-TK-2025-002', txType: 'INBOUND', quantity: 80, referenceType: 'INITIAL_STOCK', performedBy: manager.name, createdAt: new Date('2025-10-15') },
    ];
