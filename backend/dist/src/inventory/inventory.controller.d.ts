...
export declare class InventoryController {
    ...
    getCurrentStock(query: InventoryQueryDto): Promise<import("../common/dto/pagination.dto").PaginatedResult<{
        warehouse: {
            id: string;
            name: string;
            code: string;
    ...
    getTransactions(query: TransactionQueryDto): Promise<import("../common/dto/pagination.dto").PaginatedResult<{
        item: {
            id: string;
            name: string;
            code: string;
