...
export class ContainerController {
  ...
  findOne(@Param('id') id: string) { return this.containerService.findById(id); }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateContainerDto) { return this.containerService.update(id, dto); }

  @Delete(':id') @ApiOperation({ summary: '물류용기 삭제' })
  remove(@Param('id') id: string) { return this.containerService.delete(id); }
}
