...
export class OutboundController {
  ...
  update(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateOutboundOrderDto) {
  ...
  pick(@Param('id', ParseUUIDPipe) id: string, @Body() dto: PickOutboundDto) {
    return this.outboundService.pick(id, dto);
  }

  @Post(':id/ship')
  @ApiOperation({ summary: '출하 처리' })
  ship(@Param('id', ParseUUIDPipe) id: string, @Body() dto: ShipOutboundDto) {
